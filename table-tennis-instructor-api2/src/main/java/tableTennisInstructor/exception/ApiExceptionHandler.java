package tableTennisInstructor.exception;

import tableTennisInstructor.dto.response.ErrorMessageDTO;
import tableTennisInstructor.exception.exceptions.ApiRequestException;
import tableTennisInstructor.exception.exceptions.ResourceNotFoundException;
